...
create table if not exists responds(
    ...
    for_what_responded bigint not null references vacancy (id)
);
...
insert into vacancy(job_title, salary, job_description, required_max_exp, required_min_exp, date_of_posted, category_id, author_id)
values ( 'Taxi', 200.00, 'We are very friendly', 1, 5, CURRENT_DATE, 1, 1),
       ( 'Sergent', 3000.00, 'We need a man sergent', 3, 10, CURRENT_DATE, 2, 1);
